...
use App\Logic\Tools\Programs\Git\Diff\Diff;
use App\Logic\Tools\Programs\Git\Exception\InvalidArgumentException;
use App\Logic\Tools\Programs\Git\Exception\ProcessException;
use App\Logic\Tools\Programs\Git\Exception\ReferenceNotFoundException;
use App\Logic\Tools\Programs\Git\Util\StringHelper;
...
class Commit extends Revision
{
     ...
     * Constructor.
     *
     * @param App\Logic\Tools\Programs\Git\Repository $repository Repository of the commit
