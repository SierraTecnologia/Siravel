 ...
 */
namespace App\Logic\Tools\Programs\Git;

use App\Logic\Tools\Programs\Git\Exception\ReferenceNotFoundException;
use App\Logic\Tools\Programs\Git\Exception\RuntimeException;
use App\Logic\Tools\Programs\Git\Reference\Branch;
use App\Logic\Tools\Programs\Git\Reference\Stash;
use App\Logic\Tools\Programs\Git\Reference\Tag;
...
class ReferenceBag implements \Countable, \IteratorAggregate
{
     ...
     * Repository object.
     *
     * @var App\Logic\Tools\Programs\Git\Repository
     */
     ...
     * Constructor.
     *
     * @param App\Logic\Tools\Programs\Git\Repository $repository The repository
     */
