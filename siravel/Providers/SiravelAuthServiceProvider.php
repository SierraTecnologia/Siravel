...
/**
 * Class SiravelAuthServiceProvider.
 *
 * @package Siravel\Providers
 */
class SiravelAuthServiceProvider extends ServiceProvider
{
    /**
     ...
     */
    protected $policies = [
        'App\Model' => 'App\Http\Policies\ModelPolicy',
    ];
    ...
    {
        $resourcePolicy = $this->app->make(\App\Http\Policies\ResourcePolicy::class);
