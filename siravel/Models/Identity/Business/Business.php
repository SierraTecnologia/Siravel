...
class Business extends Model
{
    ...
    {
        return $this->morphToMany('Siravel\Models\Identity\Hability\Pircing', 'pircingable');
    }
    public function tatuages()
    {
        return $this->morphToMany('Siravel\Models\Identity\Hability\Tatuagem', 'tatuageable');
    }
