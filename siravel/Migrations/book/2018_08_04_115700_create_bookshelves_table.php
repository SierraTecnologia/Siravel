...
class CreateBookshelvesTable extends Migration
{
    ...
    public function down()
    {
        ...
        DB::table('activities')->where('entity_type', '=', 'App\Models\Book\Bookshelf')->delete();
        DB::table('views')->where('viewable_type', '=', 'App\Models\Book\Bookshelf')->delete();
        DB::table('entity_permissions')->where('restrictable_type', '=', 'App\Models\Book\Bookshelf')->delete();
        DB::table('tags')->where('entity_type', '=', 'App\Models\Book\Bookshelf')->delete();
        DB::table('search_terms')->where('entity_type', '=', 'App\Models\Book\Bookshelf')->delete();
        DB::table('comments')->where('entity_type', '=', 'App\Models\Book\Bookshelf')->delete();
    }
}
