...
<div page-picker>
    <div class="input-base">
        ...
        <a @if(!$value) style="display: none" @endif href="{{ baseUrl('/link/' . $value) }}" target="_blank" class="text-page" page-picker-display>#{{$value}}, {{$value ? \App\Models\Book\Page::find($value)->name : '' }}</a>
    </div>
    <br>
