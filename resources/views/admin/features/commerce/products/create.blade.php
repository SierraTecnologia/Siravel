...
@section('content')
    ...
    <div class="col-md-12 mt-2">
        @include('siravel::admin.features.commerce.products.breadcrumbs', ['location' => ['create']])

        {!! Form::open(['route' => config('siravel.backend-route-prefix', 'siravel').'.products.store', 'files' => true]) !!}
