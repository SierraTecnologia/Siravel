        ...
        <div class="row">
            <div class="@if (config('siravel.live-preview', false)) col-md-6 @else col-md-12 @endif">
                {!! Form::model($event, ['route' => ['admin.events.update', $event->id], 'method' => 'patch', 'class' => 'edit']) !!}
                    ...
                    {!! FormMaker::setColumns(3)->fromObject($event->asObject(), config('siravel.forms.event.identity')) !!}
                    {!! FormMaker::setColumns(1)->fromObject($event->asObject(), config('siravel.forms.event.content')) !!}
                    {!! FormMaker::setColumns(2)->fromObject($event->asObject(), config('siravel.forms.event.seo')) !!}
                    {!! FormMaker::setColumns(2)->fromObject($event->asObject(), config('siravel.forms.event.publish')) !!}
