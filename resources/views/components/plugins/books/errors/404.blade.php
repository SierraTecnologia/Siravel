        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card">
                    ...
                    @include('partials.entity-list', ['entities' => Views::getPopular(10, 0, [\Population\Models\Components\Book\Page::class]), 'style' => 'compact'])
                </div>
            </div>
            <div class="col-md-4">
                <div class="card">
                    <h3 class="text-muted">@icon('book') {{ trans('entities.books_popular') }}</h3>
                    @include('partials.entity-list', ['entities' => Views::getPopular(10, 0, [\Population\Models\Components\Book\Book::class]), 'style' => 'compact'])
                </div>
            </div>
            <div class="col-md-4">
                <div class="card">
                    <h3 class="text-muted">@icon('chapter') {{ trans('entities.chapters_popular') }}</h3>
                    @include('partials.entity-list', ['entities' => Views::getPopular(10, 0, [\Population\Models\Components\Book\Chapter::class]), 'style' => 'compact'])
                </div>
            </div>
        </div>
    @endif
