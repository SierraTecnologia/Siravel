...
@section('title', 'Show Collaborator')

@section('content_header')
    <h1>Show Collaborator</h1>
@stop
...
@section('content')
    ...
    <div class="row">
        ...
        <div class="box box-solid">
            ...
            <!-- /.box-header -->
            <div class="box-body">
                @include('orders.table', ['orders' => $collaborator->orders()->get()])</h3>
            </div>
            <!-- /.box-body -->
        </div>
        </div>
