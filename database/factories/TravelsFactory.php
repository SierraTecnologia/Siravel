...
$factory->define(
    \App\Models\Travels\Hotel::class, function (Faker\Generator $faker) {
        return [
        'code' => 'dumb',
        ];
    }
...
$factory->define(
    \App\Models\Travels\Room::class, function (Faker\Generator $faker) {
        return [
        'hotel_id' => function () {
...
$factory->define(
    \App\Models\Travels\Travel::class, function (Faker\Generator $faker) {
        return [
        'room_id' => function () {
