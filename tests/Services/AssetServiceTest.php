...
class AssetServiceTest extends TestCase
{
    ...
    {
        $encFileName = app(Crypto::class)->url_encode(__DIR__.'/../fixtures/test-file.txt');
    ...
    public function testAsPreview()
    {
        ...
        $encFileName = app(Crypto::class)->url_encode('test-pic.jpg');
    ...
    {
        $encFileName = app(Crypto::class)->url_encode(__DIR__.'/test-file.txt');
        $encRealFileName = app(Crypto::class)->url_encode('test-file.txt');
    ...
    public function testAsset()
    {
        $fileSystem = app(Filesystem::class);
        $encFileName = app(Crypto::class)->url_encode(__DIR__.'/test-file.txt');
        $encType = app(Crypto::class)->url_encode('plain/text');
